...
Use this *markdown* template to write pager or small reports for communication at <https://www.fineprint.global/>. In the FINEPRINT briefs use only level three headings, i.e., from `###`. The Briefs are small documents that do not require more levels. Other levels are reserved to the html headings. 
