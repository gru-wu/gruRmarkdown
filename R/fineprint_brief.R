...
#'
#' # Render brief PDF
#' rmarkdown::render(input = "my_brief/my_brief.Rmd", output_format = "gruRmarkdown::fineprint_brief")
#'
#' # Render brief HTML
#' rmarkdown::render(input = "my_brief/my_brief.Rmd", output_format = "html_document")
#'
#' }
#'
#' @export
fineprint_brief = function(..., keep_tex = TRUE, toc = FALSE, number_sections = FALSE) {
  res = rmarkdown::pdf_document(..., keep_tex = keep_tex, toc = toc, number_sections = number_sections,
